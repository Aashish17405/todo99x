  ...
  return (
    <div>
      ...
      <ul className="flex space-x-10 mt-5">
        ...
        <button className="bg-black border border-gray-300 py-2 px-4 rounded-full hover:bg-red hover:text-black hover:border-black" onClick={() => navigate('/c')}>Completed Todos</button>
