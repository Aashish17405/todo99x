...
const Completedtodos = () => {
  ...
  return (
    <div>
      ...
      <button className='px-2 py-2 bg-black text-xs sm:text-base border sm:mt-2 border-gray-300 sm:px-4 rounded-full sm:ml-56 hover:bg-red hover:text-black hover:border-black' onClick={(e) => logout({ logoutParams: { returnTo: window.location.origin } })}>Logout</button>
      {isLoading && (
